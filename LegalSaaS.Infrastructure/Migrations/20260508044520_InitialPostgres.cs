        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxLawyers = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EditorialPosts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EditorialPosts_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EditorialBioTitle = table.Column<string>(type: "text", nullable: true),
                    EditorialBioText = table.Column<string>(type: "text", nullable: true),
                    Description = table.Column<string>(type: "text", nullable: true),
                    ...
                    PrimaryColor = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false, defaultValue: "#0B192C"),
                    HeaderBackgroundColor = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false, defaultValue: "#FFFFFF"),
                    TenantId = table.Column<int>(type: "integer", nullable: false),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LawFirmSettings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LawFirmSettings_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AcademicBackground = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LawyerProfiles_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriceAtSubscription = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EditorialPosts_TenantId",
                table: "EditorialPosts",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_LawFirmSettings_TenantId",
                table: "LawFirmSettings",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_LawyerProfiles_TenantId",
                table: "LawyerProfiles",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_PageSeos_TenantId_PageKey",
                table: "PageSeos",
                columns: new[] { "TenantId", "PageKey" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_RoleModulePermissions_TenantId_RoleName_ModuleKey",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubscriptionPlanFeatures_SubscriptionPlanId_FeatureKey",
